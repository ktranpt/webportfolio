...
<h1 class="center" id="headline">
  <a href="http://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html" style="color: #dc63d3;">
    Travel Agent Chatbot System</a></h1>
<div id="info">
...
<input type="text" id="say" style="width:500px;height:50px; font-size:20pt; border: 2px solid #dc63d3;"/>
...
//Default answer
    ...
    {	
      showText = sayText = "You can type or speak to me your enquire about travelling";
    }
    else if(dialog=="show my location" || dialog=="Show my location")
    {
      var x = document.getElementById("location");
      getMyLocation();
      showText = "I'm checking your location, wait a second";
      sayText=showText;
    }
//Data classification with user data
    else if (dialog == "Should I travel to Victoria" || dialog == "should I travel to Victoria")
    {
      showText = sayText = "No, there are Covid exposure premises in Melbourne";
    }
    else if (dialog == "Where should I travel" || dialog == "where should I travel")
    {
      showText = sayText = "When do you want to go?";
    }
    else if (dialog == "June" || dialog == "next month")
    {
      showText = sayText = "Great, you should visit Hobart, there is Dark Mofo festival in June. Do you want to book Hotel?";
    }
    else if(dialog == "yes give me a recommendation")
    {
      showHotel();
      showText = sayText = "Great, I'm showing you the nearest hotels";
    }

//Recommnedation with user data
  if (dialog == "show me the top hotel" || dialog == "show me the top Hotel")
    {
        $.ajaxSetup({async: false});
          ...
          $.ajax({
          url: "/KT/app/recommend/hotel.php",
          data: {text: dialog},
    ...
    else if (dialog == "show me the top destination" || dialog == "show me the top destinations")
    {
        $.ajaxSetup({async: false});
          showText = "";
          sayText = "";
          ...
          $.ajax({
          url: "/KT/app/recommend/destination.php",
          data: {text: dialog},
          success: function (data) 
          {
            showText = sayText = "The top 3 destinations are " + data;
          }
        });
    }
...
//Opinion mining and sentiment analysis
    ...
    {
      showText = sayText = "Are you satisfied our service?";
      senti = 1; 
    } 
    else if (senti == 1) 
    {
      ...
      $.ajaxSetup({async: false});
       ...
       $.ajax({
              ...
              success : function (data){
                  if (data == 'pos') 
                  {
                      showText = sayText = "Thank you, wish you have a good day";
                  } 
                  else if (data == 'neg')
                  {
                  ...
                  {
                    showText = sayText = "Good bye, wish you have a good day";
                  }
              }
      });
    }
