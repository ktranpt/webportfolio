...
<div id="pricing" class="section-2">
	<div class="container">
        <h1>E-Ticket Prices - Admission via online bookings only</h1>
		<!-- <p style="color: #ffffff; text-align: center; font-size: 1.3em; margin-bottom: 0.8em;"></p> -->
		   <h5>Your E-Ticket gives you unlimited all day access to four worlds of fun;<br /> including Oasis Springs, Oz Adventure, Outback Explorer's and Wildlife Trail.</h5>
		<div class="row">
