  ...
  <?php get_template_part('templates/page', 'header'); ?>
		...
		<div class="fluid-container back-kv no-bottom normal-text">
			...
			<div class="promo gotham">
				<div class="container">
					New accounts enjoy 1000 FREE credits to try us out with no ongoing commitment.
				</div>
			</div>
  		</div>
		...
		<div class="container no-back">
			<div class="step-intro"><strong>Step 1:</strong> Choose Tracker</div>
			</div>
		<?php
				$args = array(
					'post_type' => 'product',
			...
			<div class="alcent product ">
				...
				<div><button class="open-prod">Select</button>
				</div>
				</div>
				<div class="form-drop">
					<div class="greenback">
				...
				// Load the template
				wc_get_template( 'single-product/add-to-cart/variable-2.php', array(
