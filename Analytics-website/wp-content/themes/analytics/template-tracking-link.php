...
<?php
/**
 * Template Name: Tracking Link Template
 */
?>
<style>
	.back-kv{
...
<?php $hot_leads = get_field('hot_leads');
$could_spark = get_field('could_spark');
$gone_cold = get_field('gone_cold'); ?>
	 ...
	 ?></h1>
  	...
  	<div class="cta-kv">
		  <span>Launch Date: <?php 
			 $date = date_create($camp->Created_Date);
			 echo date_format($date,"d M Y, H:i "); ?></span>

		<span id="total_assign_new">Open To Track: <?php echo "XXXXXXX"; ?></span>
  	</div>
  	</div>
  </div>
...
<div class="fluid-container section content-items">    
	...
	<div class="content-items">
		...
		<div class="container container-pad-50">
				...
				<div class='row tab-control'>
					<div class='col-xl-1 bgcolor active' data-id='overview'>OVERVIEW</div>
					<div class='col-xl-1 bgcolor' data-id='.hot-leads'>HOT LEADS</div>
					<div class='col-xl-1 bgcolor' data-id='.traction'>AUDIENCE TRACTION</div>
					<div class='col-xl-1 bgcolor' data-id='.ad-tracking'>CLICK TRACKING</div>
					<div class='col-xl-1 bgcolor' data-id='.email-client'>EMAIL CLIENT</div>
					<div class='col-xl-2 bgcolor' data-id='.geolocation'>GEOLOCATION</div>
					...
					<?php
							...
							if($variation_id != 0 && $variation_id != 496 && $variation_id != 624){?>


										<div class='col-xl-2 bgcolor' data-id='.report'>REPORT</div>

								
							<?php } ?><div class='col-xl-2 bgcolor' data-id='.report'>REPORT</div>
				...
				<div class="row report-title" style="display:none">

					<div class='col-xl-3'>
						<img id="report_img" src="#"/>
					</div>
					<div class='col-xl-8'>
							...
							<div>
									<span>Launch Date: 
										...
										<?php  
												echo date_format(new DateTime('now'),"d-M-Y"); 
										?>
									</span>
							</div>
					</div>
				...
				<div class="row report-box insight  insight-simmary">
					<div class="col-xl-4">
						<div>INSIGHTS</div>
				...
				<?php if($variation_id != 0 && $variation_id != 496 && $variation_id != 624){?>


					<div class='row customise-info report-box insight-simmary'>
						<div class="col-xl-12 ">
							<span>CUSTOMISE: <a href='#' class='customise-modules'>Click</a> to customise modules & layout of this overview page</span>
						</div>
					</div>
    ...
    margin-bottom: 20px;">
									...
									<span><select id='daily_hourly'><option value="1">every 4 hours</option><option value="3">every 8 hours</option><option value="2" selected>daily</option></select></span>  
								</div>
				...
				<!-- <div class="report-box ad-tracking">
							...
							<?php 	// create curl resource 
										...
										for ($i=0; $i < count($response); $i++) { ?>
													...
													<tr>
														...
														<td><?php echo '';?></td>
														<td><?php echo $response[$i]->total;?></td>
														<td><?php echo $response[$i]->ld_platform;?></td>
														<td><?php echo date('d-M-Y h:i:s',strtotime($response[$i]->ld_timestamp));?></td>
					...
					<div class="row customise-control">
								...
								<div class="report-box col-xl-4 report bg-color border-right" style='display:none;'>
									...
									<div>
										<div class='module' data-value='insight-simmary'>Insight Summary</div>
										<div class='module' data-value='total-clicks'>Total Clicks</div>
										<div class='module' data-value='unique-clicks'>Unique Clicks</div>
										<div class='module' data-value='total-opens'>Total Opens</div>
										<div class='module' data-value='unique-opens'>Unique Opens</div>
										<div class='module' data-value='total-prints'>Total Prints</div>
										<div class='module' data-value='unique-prints'>Unique Prints</div>
										<div class='module' data-value='total-forwards'>Total Forwards</div>
										<div class='module' data-value='unique-forwards'>Unique Forwards</div>
										<div class='module' data-value='hot-leads'>Hot Leads</div>
										<div class='module' data-value='daily-activity'>Daily Activity</div>
										<div class='module' data-value='.traction'>Audience Engagement</div>
										<div class='module' data-value='reading-trend'>Reading Trend</div>
										<div class='module' data-value='email-client'>Email Client</div>
										<div class='module' data-value='geolocation'>Geo-Location</div>
										<div class='module' data-value='ad-tracking'>Links Tracking Details</div>
										
									</div>
								</div>	
								<div class="report-box col-xl-4 report bg-color border-right" style='display:none;padding-left: 10px;'>
									<div class='select-module'>SELECT PERFORMANCE COMPARISON:</div>
										<div>
											<div class='module' data-value=''>None</div>
											<div class='module' data-value=''>Overal Averages</div>
											<div class='module' data-value=''>Industry Averages</div>
											<div class='module' data-value=''>Your Previous Campaign</div>
											<div class='module' data-value='clicks-comparison'>Selected Previous Campaigns</div>
											<?php 	// create curl resource 
										$ch = curl_init();
				...
				<?php if($variation_id != 0 && $variation_id != 496 && $variation_id != 624){ ?>
					...
					<div class="row">
							<div class="report-box col-xl-12 report">
									<!-- <div><i class="fa fa-angle-left" aria-hidden="true"></i></div> -->
									<div class="report-header margin-top"><p>Recent Reports</p></div>
									
									<div class='report-body'>
									<table id='report_table' class="pure-table pure-table-horizontal" style="    width: 100%;"> 
							<thead>
								<tr>
									<th>Id</th>
							...
							<?php 	// create curl resource 
										...
										curl_setopt($ch, CURLOPT_URL, $base_api . "api/campaign/get_reports"); 
										...
										for ($i=0; $i < count($response); $i++) { ?>
													...
													<tr>
														...
														<td><?php echo $response[$i]->re_id;?></td>
														<td>
															<?php 
																	$options = explode(',', $response[$i]->re_selected);
																	for ($j=0; $j < count($options); $j++) { 
																		echo implode(' ', explode('-', $options[$j])) . ', ';
																	}
															?>
														  
														
														</td>
														<td><a href='<?php echo get_home_url()?>/report/?re_code=<?php echo $response[$i]->re_code;?>' target="_blank" style='color:#05c8c2'><?php echo $response[$i]->re_code;?></a></td>
					...
					<div class="row hot-leads" style="margin-bottom:10px">
							...
							<div class="report-box col-xl-4 hot-leads">
										<div class='hot-leads-box bg-color'>
											<div><img src="<?php echo $hot_leads ?>" /></div>
											<div class='hot-leads-text'>Hot Leads <span><i class="fa fa-question" aria-hidden="true"></i></span></div>
											<div class='hot-leads-total' id='hot-leads-0'>0</div>
										</div>
										
							</div>
							<div class="report-box col-xl-4 hot-leads">
							<div class='hot-leads-box bg-color'>
										<div><img src="<?php echo $could_spark ?>" /></div>
										<div class='hot-leads-text'>Could Spark <span><i class="fa fa-question" aria-hidden="true"></i></span></div>
											<div class='hot-leads-total' id='hot-leads-1' >0</div>
							</div>							
										
							</div>
							<div class="report-box col-xl-4 hot-leads">
									<div class='hot-leads-box bg-color'>
									<div><img src="<?php echo $gone_cold ?>" /></div>

											<div class='hot-leads-text'>Gone Cold <span><i class="fa fa-question" aria-hidden="true"></i></span></div>	
											<div class='hot-leads-total' id='hot-leads-2'>0</div>
									</div>	
										
							</div>

					 </div>
					 <div class='row no-padding2 view-list' style='display:none;'>
					 ...
					 <div class="row report-box hot-leads arrow-box">
						 	<div class="col-xl-4" ><div class="arrow-down" ></div></div>
							<div class="col-xl-4" ><div class="arrow-down"></div></div>
							<div class="col-xl-4" ><div class="arrow-down"></div></div>
					</div>
					 <div class='row'>
							<div class="report-box col-xl-12 hot-leads" >
									<div class='report-body'>
										<table id='hot_leads_table' class="pure-table pure-table-horizontal" style="display:none ;   width: 100%;">
											<thead>
												<tr>
													<th>Email</th>
													<th>Reading Time</th>
...
<div class="container">
	<div class="row">
	 	<div class="col-md-8 auto">
	 		...
	 		<div class="col-md-3 no-lm"><button class='submit_btn'>Submit</button></div>
...
//			 			            fillColor: '#382765',
		...
		jQuery(document).ready(function(){
			...
			jQuery('.total_click').each(function () {
			  ...
			  load_opens_clicks_activity(2,undefined,0);
