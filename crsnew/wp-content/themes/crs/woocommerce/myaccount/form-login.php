...
<?php endif; ?>
		...
		<form class="woocomerce-form woocommerce-form-login login" method="post">
			...
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
					<input class="woocommerce-form__input woocommerce-form__input-checkbox form-control" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php _e( 'Remember me', 'woocommerce' ); ?></span>
				</label>
	...
	<div class="u-column2 col-12 col-md-6">
		...
		<form method="post" class="register">
			...
			<p class="woocomerce-FormRow form-row">
				...
				<input type="submit" class="woocommerce-Button button form-control" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
